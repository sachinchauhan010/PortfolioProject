    ...
    <div className="md:flex md:justify-center gap-x-10 md:p-8 bg-blue-50 text-center relative">
      <div className="flex-col items-center md:items-center md:justify-center md:w-1/2 font-Roboto p-2 md:text-start">
        <p className="md:text-4xl xl:text-6xl text-3xl font-bold text-blue-900 md:my-4 my-2">
          Hello, I am <br /><span className="text-fuchsia-500">Sachin Chauhan</span>
        </p>
        ...
        <p className="md:text-lg text-base lg:text-xl font-semibold flex flex-wrap text-center md:text-start px-10 md:p-0">
          I'm a Web developer and I have Problem Solving Skill. I have knowledge
          of Database also. It's my portfolio website. Here you will learn about
          my Journey.
        </p>
      ...
      <img
        src={photo}
        alt=""
        className="object-contain w-[280px] sm:ml-auto sm:mr-auto md:mx-10 p-2 rounded-md shadow-lg lg:shadow-2xl shadow-fuchsia-300 m-6 sm:h-80 lg:h-96 xl:h-112 2xl:h-128"
      />
