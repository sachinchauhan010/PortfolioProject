      ...
      <div className="flex flex-col md:flex-row md:justify-center gap-x-10 md:p-8 text-center relative box-border">
        <div className="flex-col items-center justify-center md:items-center md:justify-center md:w-1/2 font-Roboto p-2 md:text-start">
          <p className="md:text-4xl xl:text-6xl text-3xl font-bold md:my-4 my-2">
            <p className="text-xl md:text-2xl lg:text-3xl font-normal">Hello, I'm</p>
            <span className="text-primary">Sachin Chauhan</span>
          </p>
          <p className="md:text-3xl xl:text-4xl font-bold text-2xl md:my-3 my-2">
            Full Stack Developer
          </p>
          <p className="md:text-lg text-base lg:text-xl font-normal flex flex-wrap text-center md:text-start px-10 md:p-0">
          ...
          <div className="flex justify-start gap-x-10 flex-row text-primary py-5">
            ...
            <button className="border-2 py-2 px-4 rounded mt-10 hover:text-primary hover:border-primary">
              <Link
                target="_blank"
        ...
        <img
          src={photo}
          alt=""
          className="object-contain hidden md:block w-[350px] sm:ml-auto sm:mr-auto md:mx-10 p-2 rounded-md shadow-lg lg:shadow-2xl m-6 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 shadow-primary"
        />
