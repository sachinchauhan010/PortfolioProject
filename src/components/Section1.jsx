    ...
    <>
      ...
      <img
        ...
        <div className="flex-col flex-wrap md:px-10">
          <p className="md:text-3xl xl:text-5xl text-2xl text-center font-bold text-primary md:my-4 my-2">
            Full Stack Web Developer
          </p>
          <p className="md:text-base text-sm font-normal lg:text-lg flex flex-wrap md:text-start md:px-10 md:p-0">
          ...
          <p className="md:text-base text-sm font-normal lg:text-lg flex flex-wrap md:text-start md:px-10 md:p-0 mt-6">
          ...
          <p className="md:text-lg text-base lg:text-xl font-semibold flex flex-wrap text-center md:text-start sm:mx-10 px-10 md:p-0 text-primary cursor-pointer my-4">
            Full Stack Web Development
          </p>
          <p className="md:text-lg text-base lg:text-xl font-semibold flex flex-wrap text-center md:text-start px-10 sm:mx-10 md:p-0 text-primary cursor-pointer my-4">
            Problem Solving
          </p>
        </div>
      </div>
